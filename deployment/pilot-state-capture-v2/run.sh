#!/usr/bin/env bash
# Capture schema v2: read-only strict-allowlist provenance capture of the verified Stage-3 WebUI/TTS/RKLLM pilot.
...
printf '%s\n' \
    '# Stage-3 WebUI/TTS/RKLLM pilot capture (schema v2)' \
    '' \
